...
func printHelp() {
	...
	fmt.Printf("  GRAIN stores configuration, database, and log files in a data directory.\n")
	fmt.Printf("  The directory is resolved in this order:\n")
	fmt.Printf("    1. --data-dir flag (highest priority)\n")
	fmt.Printf("    2. GRAIN_DATA_DIR environment variable\n")
	fmt.Printf("    3. Platform default:\n")
	fmt.Printf("         Linux:   ~/.grain/\n")
	fmt.Printf("         macOS:   ~/Library/Application Support/grain/\n")
	fmt.Printf("         Windows: %%APPDATA%%\\grain\\\n\n")
	fmt.Printf("Configuration:\n")
	fmt.Printf("  GRAIN uses YAML configuration files that are automatically created\n")
	fmt.Printf("  in the data directory on first run if they don't exist:\n")
...
func printConfigHelp() {
	...
	fmt.Printf("Data Directory:\n")
	fmt.Printf("  All configuration, database, and log files are stored in the\n")
	fmt.Printf("  data directory. Override with --data-dir or GRAIN_DATA_DIR.\n")
	fmt.Printf("  Defaults:\n")
	fmt.Printf("    Linux:   ~/.grain/\n")
	fmt.Printf("    macOS:   ~/Library/Application Support/grain/\n")
	fmt.Printf("    Windows: %%APPDATA%%\\grain\\\n\n")
	...
	fmt.Printf("    GRAIN_DATA_DIR - Data directory path\n")
	fmt.Printf("    NDB_PATH       - nostrdb data directory path\n")
